...
export class ProductsComponent implements OnInit {
  displayedColumns: string[] = ['name', 'price', 'unitOfMeasurement', 'tvaValue', 'containsTVA'];
  ...
  getProducts(): void {
    this.productService.getProductsForUserId(this.authService.userId).subscribe((products) => {
